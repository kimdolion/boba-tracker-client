...
const authenticatedOptions = (
  <React.Fragment>
    <p>Check out the bubble tea collection so far by clicking on <Link to="/orders" className='btn btn-dark m-2'>All Orders</Link> or your own collection <Link to="/my-orders" className='btn btn-secondary m-2'>My Orders</Link>
    </p>
